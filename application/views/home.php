                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="<?php base_url()?>img/004-technology.svg" width="70px" height="70px">
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="<?php base_url()?>img/003-customer-service.svg" width="70px" height="70px">
                                    </div>
                                    <div class="col-xs-9 text-right">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="<?php base_url()?>img/002-barcode.svg" width="70px" height="70px">
                                    </div>
                                    <div class="col-xs-9 text-right">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="<?php base_url()?>img/001-money-bag.svg" width="70px" height="70px">
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">13</div>
                                        <div>Vendas</div>
